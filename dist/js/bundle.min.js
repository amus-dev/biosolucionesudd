...
// EXTERNAL MODULE: ./src/js/modules/common/preload.js
var preload = __webpack_require__(117);
// EXTERNAL MODULE: ./src/js/modules/common/menu.js
var menu = __webpack_require__(712);
// EXTERNAL MODULE: ./src/js/modules/common/alertCovid.js
var alertCovid = __webpack_require__(310);
...
;// CONCATENATED MODULE: ./src/js/modules/carousels/accreditations.js
// import Swiper JS
...
class SlidesAccreditations extends HTMLElement {
  ...
  connectedCallback() {
    const swiper = new core_class(".swiper-container", {
      slidesPerView: 1,
      spaceBetween: 30,
      loop: true,
      pagination: {
...
;// CONCATENATED MODULE: ./src/js/modules/buzon/utils/const.js
const user = {
  nameUser: String,
  rutUser: String,
  address: String,
...
// EXTERNAL MODULE: ./node_modules/@fdograph/rut-utilities/build/main.js
var main = __webpack_require__(212);
;// CONCATENATED MODULE: ./src/js/modules/buzon/functions/index.js


const isemail = __webpack_require__(315);
...
const VALIDATE_SHOW_ALERTS = () => {
  ...
  !(0,main.validateRut)(user.rutUser)
  ...
  !(0,main.validateRut)(user.rutPacient)
  ...
  if (
    user.nameUser &&
    (0,main.validateRut)(user.rutUser) === true &&
    user.address &&
    user.comuna &&
    user.phone &&
    isemail(user.emailUser) &&
    user.namePacient &&
    (0,main.validateRut)(user.rutPacient) === true &&
    user.descriptionReclamo
  ) {
    return true;
  } else {
...
;// CONCATENATED MODULE: ./src/js/modules/buzon/form.js
...
// EXTERNAL MODULE: ./src/js/modules/team/index.js
var team = __webpack_require__(941);
