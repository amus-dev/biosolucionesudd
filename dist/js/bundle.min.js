...
;// CONCATENATED MODULE: ./src/js/modules/buzon/functions/const.js
const user = {
  nameUser: String,
  rutUser: String,
  address: String,
...
const VALIDATE_SHOW_ALERTS = () => {
  ...
  if(user.nameUser && (0,main.validateRut)(user.rutUser)=== true && user.address && user.comuna && user.phone && isemail(user.emailUser) && user.namePacient && (0,main.validateRut)(user.rutPacient)===true && user.descriptionReclamo){
    return true;
  }
  else{
    const messageForm = document.getElementById("messageForm");
